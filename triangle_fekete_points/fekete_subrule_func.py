...
# def fekete_subrule(rule, suborder_num):
#     """
#     Return compressed Fekete rule (barycentric coords + weights)

#     Returns
#     -------
#     suborder_xyz : list of [l1, l2, l3]
#     suborder_w   : list of weights
#     """

#     if rule == 1:
#         suborder_xyz, suborder_w = fekete_subrule_1(suborder_num)
#     elif rule == 2:
#         suborder_xyz, suborder_w = fekete_subrule_2(suborder_num)
#     elif rule == 3:
#         suborder_xyz, suborder_w = fekete_subrule_3(suborder_num)
#     elif rule == 4:
#         suborder_xyz, suborder_w = fekete_subrule_4(suborder_num)
#     elif rule == 5:
#         suborder_xyz, suborder_w = fekete_subrule_5(suborder_num)
#     elif rule == 6:
#         suborder_xyz, suborder_w = fekete_subrule_6(suborder_num)
#     elif rule == 7:
#         suborder_xyz, suborder_w = fekete_subrule_7(suborder_num)
#     else:
#         raise ValueError(f"FEKETE_SUBRULE - Illegal RULE = {rule}")

#     # Scale weights (important!)
#     suborder_w = [0.5 * w for w in suborder_w]

#     return suborder_xyz, suborder_w


import numpy as np

def fekete_subrule(rule):
    """
    Returns (suborder_xyz, suborder_w) for a given rule.
    
    suborder_xyz: shape (N, 3) barycentric coordinates
    suborder_w:   shape (N,) weights
    """
    ...
    if rule == 1:
        xyz = np.array([
            ...
            [1.0,          0.0,          0.0],
            [0.0,          0.2763932023, 0.7236067977],
        ])
        w = np.array([0.9, 0.0333333333, 0.1666666667])
        ...
        xyz = np.array([
            ...
            [0.0,          0.2655651402, 0.7344348598],
            [0.0,          0.0848854223, 0.9151145777],
        ])
        w = np.array([
            0.2178563571,
            0.1104193374,
        ...
        xyz = np.array([
            ...
            [0.0,          0.4173602935, 0.5826397065],
            [0.0,          0.2610371960, 0.7389628040],
            [0.0,          0.1306129092, 0.8693870908],
            [0.0,          0.0402330070, 0.9597669930],
        ])
        w = np.array([
            0.1096011288,
            0.0767491008,
        ...
        raise ValueError(f"Rule {rule} not implemented yet")
