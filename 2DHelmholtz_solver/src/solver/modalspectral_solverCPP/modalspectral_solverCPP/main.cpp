...
#include "solver/modal_spectral_solver.h"
...
int main()
{
	...
	for (int i = 0; i < nodeCount; i++)
	{
		...
		x_coord = x_coord * 1000000.0; // For testing, no scaling applied here
		y_coord = y_coord * 1000000.0; // For testing, no scaling applied here
	...
	modal_spec_solver.init(&helmholtz_2dsystem, output_file, &stopwatch, m_callback);
	...
	bool isAnalysisSuccess = modal_spec_solver.solve_modal_analysis(number_of_modes, solver_type, geom_min_x, geom_min_y, scale_value);
