...
namespace _2DHelmholtz_solver.src.model_store.geom_objects
{
    ...
    public class rsltlabel_list_store
    {
        public Dictionary<int, rsltlabel_store> labelMap { get; } = new Dictionary<int, rsltlabel_store>();
        ...
        private VertexArrayR1 _labelVAO;
        private VertexBufferR1 _labelVBO;
        private IndexBufferR1 _labelIBO;

        public Shader _labelshader;

        public rsltlabel_list_store()
        {
            // (Re)Initialize the data
            labelMap = new Dictionary<int, rsltlabel_store>();
            label_count = 0;
            total_char_count = 0;
        ...
        public void add_label(int label_id, string label, Vector2 label_loc, Vector3 label_color)
        {
            ...
            rsltlabel_store temp_label = new rsltlabel_store
            {
                label_id = label_id,
                label = label,
                label_loc = label_loc,
        ...
        private void InitializeShader()
        {
            ...
            // Create Shader
            _labelshader = new Shader(ShaderLibrary.get_vertex_shader(ShaderLibrary.ShaderType.RsltTextShader),
                ShaderLibrary.get_fragment_shader(ShaderLibrary.ShaderType.RsltTextShader));
        ...
        {
            // Label buffer
            _labelVAO = new VertexArrayR1();
            _labelVBO = new VertexBufferR1(10);
            _labelIBO = new IndexBufferR1(10);
        ...
        private void get_label_vertex_buffer(rsltlabel_store lb, ref List<float> label_vertices)
        {
        ...
        private void get_label_index_buffer(rsltlabel_store lb, ref List<int> label_indices, ref int t_id)
        {
