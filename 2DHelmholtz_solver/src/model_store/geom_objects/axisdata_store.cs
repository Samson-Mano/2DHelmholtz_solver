...
namespace _2DHelmholtz_solver.src.model_store.geom_objects
{
    public class axisdata_store : IDisposable
    {
        ...
        // XY labels
        private rsltlabel_list_store XY_label; // = new label_list_store();
        ...
        // Rendering resources
        private VertexArrayR1 _axisarrowVAO;
        private VertexBufferR1 _axisarrowVBO;
        private IndexBufferR1 _axisarrowIBO;
        ...
        public void InitializeAxisData(int window_width, int window_height)
        {
            ...
            XY_label = new rsltlabel_list_store();
        ...
        {
            // Axis arrows 
            _axisarrowVAO = new VertexArrayR1();
            _axisarrowVBO = new VertexBufferR1(VERTEX_COUNT * 5);
            _axisarrowIBO = new IndexBufferR1(LINE_INDEX_COUNT);
        ...
        private void UpdateVertexBuffers()
        {
            ...
            XY_label.add_label(1, "Y", new Vector2(OriginX + 0.018f, OriginY + 0.1f), new Vector3(0.0f, 0.0f, 1.0f)); // OriginY + 0.135f
